class Item():
    def __init__(self, name="Mysterious item", description="This item is of an unknown origin", indestructable=False, heavy=False):
        self.name = name
        self.description = description
        self.indestructable = indestructable == "True"
        self.heavy = heavy == "True"
